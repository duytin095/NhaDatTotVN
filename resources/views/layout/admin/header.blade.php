                        ...
                        <div class="customScroll">
                            <ul class="header-notifications">
                                <li>
                                    <a href="#">
                                        <div class="user-img online">
                                            <img src="{{asset('assets/admin/img/user6.png')}}" alt="User">
                                        </div>
                                        <div class="details">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="user-img busy">
                                            <img src="{{asset('assets/admin/img/user10.png')}}" alt="User">
                                        </div>
                                        <div class="details">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="user-img away">
                                            <img src="{{asset('assets/admin/img/user21.png')}}" alt="User">
                                        </div>
                                        <div class="details">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="user-img online">
                                            <img src="{{asset('assets/admin/img/user5.png')}}" alt="User">
                                        </div>
                                        <div class="details">
