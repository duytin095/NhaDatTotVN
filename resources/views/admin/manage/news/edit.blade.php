            ...
            <div class="card-body">
                    ...
                    <div class="field-wrapper">
                        <div class="input-group">
                            <input maxlength="" name="title" type="text" class="form-control"
                                value="{{ $news->title }}" placeholder="Nhập tiêu đề tin"
                                aria-describedby="remaining-characters">
                        ...
                        <select name="type" class="select-single js-states" title="Select Property Type"
                            ...
                            @foreach ($news_types as $news_type)
                                <option value="{{ $news_type['id'] }}"
                                    {{ $news['type'] == $news_type['id'] ? 'selected' : '' }}> {{ $news_type['name'] }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div>
                        ...
                        <button class="btn btn-primary" onclick="updateNews({{ $news['id'] }})" type="button">Lưu
                            tin</button>
                    </div>
                </div>
            </div>
